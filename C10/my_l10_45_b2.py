...
class Zoo:
    ...
    # def transfer_animal(self, target_zoo, *animals): #Wrong method. See exception handling.
    #     for animal in animals:
    #         for cage in self.cages:
    #             if animal in cage.animals:
    #                 cage.remove_animal(animal)
    #                 for newcage in target_zoo.cages:
    #                     try:
    #                         newcage.add_animals(animal)
    #                     except:
    #                         pass
    ...
    def robust_transfer_animal(self, target_zoo, species):
        """
...
z1.robust_transfer_animal(z2, Sheep)
z1.transfer_animal(z2, Snake)
z1.robust_transfer_animal(z2, Parrot)
